<?php
/**
 * WC Ajax Layered Navigation with Multi-Select Filters by Category
 */
if (!class_exists('WCHWEB_Category_Filter_Widget')) {
	class WCHWEB_Category_Filter_Widget extends WP_Widget {
		/**
		 * Register widget with WordPress.
		 */
		function __construct() {
			parent::__construct(
				'wchweb-category-filter', // Base ID
				__('WC Ajax Layered Navigation with Multi-Select Filters by Category', 'wchweb'), // Name
				array('description' => __('Filter woocommerce products by category.', 'wchweb')) // Args
			);
		}
...
// register widget
if (!function_exists('wchweb_register_category_filter_widget')) {
	function wchweb_register_category_filter_widget() {
		register_widget('WCHWEB_Category_Filter_Widget');
	}
	add_action('widgets_init', 'wchweb_register_category_filter_widget');
}